...
class FuncionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcion" do
    assert_difference('Funcion.count') do
      post funcions_url, params: { funcion: { dia: @funcion.dia, num_sillas: @funcion.num_sillas, pelicula: @funcion.pelicula } }
    end
  ...
  test "should update funcion" do
    patch funcion_url(@funcion), params: { funcion: { dia: @funcion.dia, num_sillas: @funcion.num_sillas, pelicula: @funcion.pelicula } }
