...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { dia: @reserva.dia, funcion_id: @reserva.funcion_id, user_id: @reserva.user_id } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { dia: @reserva.dia, funcion_id: @reserva.funcion_id, user_id: @reserva.user_id } }
