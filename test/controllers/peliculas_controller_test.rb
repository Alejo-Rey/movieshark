...
class PeliculasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pelicula" do
    assert_difference('Pelicula.count') do
      post peliculas_url, params: { pelicula: { descripcion: @pelicula.descripcion, dia_funcion: @pelicula.dia_funcion, funcion_id: @pelicula.funcion_id, nombre: @pelicula.nombre, url_imagen: @pelicula.url_imagen } }
    end
  ...
  test "should update pelicula" do
    patch pelicula_url(@pelicula), params: { pelicula: { descripcion: @pelicula.descripcion, dia_funcion: @pelicula.dia_funcion, funcion_id: @pelicula.funcion_id, nombre: @pelicula.nombre, url_imagen: @pelicula.url_imagen } }
